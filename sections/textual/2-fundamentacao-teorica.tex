...
Neste contexto, surgiu o movimento NoSQL (\textit{Not Only SQL}), que, traduzido de forma livre, significa "não somente SQL". Este movimento sugere uma nova abordagem para o gerenciamento de dados, propondo modelos mais flexíveis e escaláveis, que não se restringem ao paradigma relacional tradicional.
